...
class _$registerObjectImpl implements _registerObject {
  _$registerObjectImpl(this.userName, this.password, this.email,
      this.mobileNumber, this.profilePicture, this.countryMobileCode);
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, password: $password, email: $email, mobileNumber: $mobileNumber, profilePicture: $profilePicture, countryMobileCode: $countryMobileCode)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, userName, password, email,
      mobileNumber, profilePicture, countryMobileCode);
...
abstract class _registerObject implements RegisterObject {
  factory _registerObject(
      ...
      final String mobileNumber,
      final String profilePicture,
      final String countryMobileCode) = _$registerObjectImpl;
